...
class AnimalCacheServiceTest extends BaseIntegrationTest {
    ...
    class SaveAnimalTest {
        ...
        void saveAnimal1() {
            ...
            // when
            animalCacheService.saveAnimal(newAnimal);
    ...
    class DeleteAnimal {
        ...
        void deleteAnimal1() {
            ...
            // when
            animalCacheService.deleteAnimal(animalToDelete);
    ...
    class FindAnimalsTest {
        ...
        void findAnimals1() {
            ...
            // when
            List<FindAnimalResponse> result = animalCacheService.findAnimals(size, animalCount)
                .animals();
