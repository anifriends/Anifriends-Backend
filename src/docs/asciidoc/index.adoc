...
operation::animal-controller-test/find-animals-by-volunteer[snippets='http-request']

==== Response

operation::animal-controller-test/find-animals-by-volunteer[snippets='http-response,response-fields']

=== 보호 동물 검색 & 조회 v2

==== Request

operation::animal-controller-test/find-animals-by-volunteer-v2[snippets='http-request']

==== Response

operation::animal-controller-test/find-animals-by-volunteer-v2[snippets='http-response,response-fields']
...
operation::volunteer-controller-test/find-volunteer-profile[snippets='http-request,path-parameters,request-headers']
...
operation::volunteer-controller-test/register-volunteer[snippets='http-request,request-headers,request-fields']
...
operation::volunteer-controller-test/check-duplicate-volunteer-email[snippets='http-request,request-headers,request-fields']
